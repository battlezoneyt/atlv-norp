...
alt.onServer('Client:Inventory:PlayAnimation', (animDict, animName, duration, flag, lockpos, animtype) => {
    alt.emit('objectAttacher:attachObject', animtype);
...
function SetInventoryInformations(invArray, backpackSize) {
    ...
    for (var i in invArray) {
        ...
        } else if (invArray[i].itemLocation == "key") {
